...
/* *****************************************************************************
    ...
    2.19            25/05/2026      APM                 Se modifica filtro en la tabla ENEL_PREFACT_DETALLE_ALIADO
**************************************************************************** */
...
begin
    ...
    INSERT INTO ENELEXT.ENEL_TXN_TEMP_ALIADO( TENANTID, PERIODSEQ, PERIODO, SALESORDERSEQ, SALESTRANSACTIONSEQ, ORDERID, LINENUMBER, SUBLINENUMBER, EVENTYPEID, COMPENSATIONDATE, 
                                                ...
                                                COSTE, FECHA_ACTIVACION,fecha_cc)
    SELECT 
        TXN.TENANTID ,
...
begin
    ...
    FROM ENEL_CREDIT_TEMP_ALIADO CREDTMP
        ...
        WHERE  
            ...
            /*BOM APM 25.05.2026 Old Code*/
            --OR TXNTMP.EVENTYPEID like '%No Activaci%n Aliados%'
            --New Code
            OR TXNTMP.EVENTYPEID='Activacion ALIADOS'
            OR TXNTMP.EVENTYPEID='No Activacion Aliados'
            /*EOM APM 25.05.2026*/
